Config({
    ...
    "login-type": "user",
    "news-line": "...:::: اهلا بكم في شبكتنا - نقدم أفضل الخدمات - باقات تناسب جميع المشتركين - شكرا لاستخدامك خدماتنا - يرجى الإحتفاظ بالكرت لحين إنتهاء فترة الصلاحية او الرصيد::::...",
    "input-type": "number",
