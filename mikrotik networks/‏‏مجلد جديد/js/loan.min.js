...
function loanError(a){console.log("error");console.log(a);var b=document.getElementById("error");"onLoginError"===a.action&&isTrial()&&"your traffic limit is reached"!==a.error_orig?b.innerText="áÇíãßäß ÇÎÐ ÇáÇäÊÑäÊ ÇáãÌÇäí ÇÐÇ áã ÊÓÊÎÏã 5 ßÑæÊ Çæ ÇßËÑ ÈåÐÇ ÇáÌåÇÒ ãä ÈÚÏ ÊÑßíÈ ÇáÎÏãÉ":"onLoginError"===a.action&&/invalid username|not found/.test(a.error)?b.innerText="ÎÏãÉ ÇáÇäÊÑäÊ ÇáãÌÇäí ãÊæÞÝÉ Ýí ÇáæÞÊ ÇáÍÇáí":b.innerText="áÇíãßäß ÇÓÊÎÏÇã ÇáÇäÊÑäÊ ÇáãÌÇäí ÇßËÑ ãä ãÑÉ æÇÍÏÉ .. ÓíÊã ÝÊÍ ÇáÇäÊÑäÊ ÇáãÌÇäí ãÌÏÏÇ   ÊáÞÇÆí ";showErrorPopup();
